        ...
        <>
            <div id="projectsComponent" className="mainProjectComponentDiv">
                ...
                <div className="subProjectComponentDiv">
                    ...
                    {/* <ProjectImageShower projectsImageData={projectImages.current[0][isDesktopMode[5]]} isDesktopMode={isDesktopMode} setIsDesktopMode={setIsDesktopMode} componentKey={5} /> */}
                </div>
            </div>
        </>
    )
