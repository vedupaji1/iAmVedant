                                ...
                                <div id="aboutSubDetails2" className="subAboutMeDetails">
                                    ...
                                    <div className="aboutMeInfo">
                                        <h1 style={{ paddingBottom: "2rem", fontSize: "'Inconsolata', monospace" }}>Hi,</h1>
                                         &nbsp;👋 I Am A Blockchain Developer And Currently Exploring Web3 Technology. <br />                               
                                        ➡️ I Enjoy In Blockchain Development And I Likes To Create Robust Smart Contracts Using Solidity.  <br />
                                        ➡️ Skilled ReactJs Developer And Able To Create Robust Backend Using NodeJs.  <br />
                                        ➡️ I Uses MERN Stack For Web Development And For Blockchain Development I Uses Solidity, Hardhat And EtherJs.  <br />
                                        ➡️ Always Ready To Learn Useful Things. <br />                                                              
                                    </div>
                                </div>
                            </div>
                        </div>
