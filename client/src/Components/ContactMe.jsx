...
import { SiGithub, SiFacebook, SiInstagram, SiTwitter } from 'react-icons/si';
            ...
            <div id="contactMeComponent" className="mainContactMeDiv">
                ...
                <footer>
                    <div className="footerMainDiv">
                        ...
                        <a href="https://www.facebook.com/panchal.vedant.96" target="_blank">
                            <div style={{ backgroundColor: "#4267B2" }} className="socialMediaIconShower"><SiFacebook style={{ color: "white" }} /></div>
                        </a>
                        <a href="https://www.instagram.com/vedupaji/" target="_blank">
                            <div style={{ backgroundColor: "#cd486b" }} className="socialMediaIconShower"><SiInstagram style={{ color: "rgb(255, 255, 255)" }} /></div>
                        </a>
                        <a href="https://twitter.com/Vedupaji4" target="_blank">
