...
const Dashboard = () => {
  ...
  const showTypingText = async () => {
    if (isShowTypingText.current !== false) {
      let arr = ["Blockchain Developer", "Full Stack Developer"];
      let curInd = 0;
      ...
      <div id="homeComponent" className="dashboardMainDiv">
        <div className="mainTechImageCube">
          <div className="techImagesForCube" id="techImage1">
            <img
              src="https://d2908q01vomqb2.cloudfront.net/ca3512f4dfa95a03169c5a670a4c91a19b3077b4/2019/09/20/rust-social-wide.jpg"
              alt=""
            />
          ...
          <div className="techImagesForCube" id="techImage2">
            <img
              src="https://vectorseek.com/wp-content/uploads/2023/03/Golang-Gopher-Logo-Vector.jpg"
              alt=""
            />
          ...
          <div className="techImagesForCube" id="techImage3">
            <img
              src="https://icon-library.com/images/node-js-icon/node-js-icon-15.jpg"
              alt=""
            />
          </div>
          ...
          <div className="techImagesForCube" id="techImage6">
            <img
              src="https://imageio.forbes.com/specials-images/imageserve/60be57e131b5299078734980/Solana-logo/0x0.png?format=png&crop=692,461,x0,y104,safe&width=960"
              alt=""
            />
          </div>
        </div>
        <div className="developerDetails">
          <div className="developerName">
            I Am <span style={{ color: "#61dafb" }}>Vedant</span>
          </div>
          <div
            style={{ color: "rgb(151 153 209)" }}
